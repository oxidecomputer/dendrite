...
const int EXTERNAL_SUBNETS_V4_SIZE  = 512;  // external subnets mapped to instances
const int EXTERNAL_SUBNETS_V6_SIZE  = 512;  // external subnets mapped to instances
