...
parser EgressParser(packet_in pkt,
    ...
    state parse_bridge_md {
        pkt.extract(bridge_md);

        meta.nat_ingress_hit = (bool)bridge_md.nat_ingress_hit;
        meta.mcast_group = bridge_md.mcast_group;
        meta.body_checksum = bridge_md.body_checksum;
        meta.icmp_recalc = (bool)bridge_md.icmp_recalc;
        meta.icmp_csum = bridge_md.icmp_csum;
        meta.l4_length = bridge_md.l4_length;
        meta.flow_hash = bridge_md.flow_hash;
