...
# The tofino2 has 20 stages, but the current sidecar.p4 will fit into 20.  We
# add the "--stages 20" here to detect if/when the program grows beyond that
...
PATH=/opt/gcc-12/bin:$PATH cargo xtask codegen --stages 20
